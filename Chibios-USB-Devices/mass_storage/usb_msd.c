 ...
 */
static void msdInit(USBMassStorageDriver *msdp);
 ...
 */
static void msdStart(USBMassStorageDriver *msdp, const USBMassStorageConfig *config);
 ...
 */
static void msdStop(USBMassStorageDriver *msdp);
 ...
 * @iclass
 */
static void msdConfigureHookI(USBMassStorageDriver *msdp);
