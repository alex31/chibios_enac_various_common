...
my %configByParam = ('SYS'	=> {A_MODE => 'ALTERNATE', A_OTYPE => 'PUSHPULL',  A_SPEED => 'SPEED_HIGH',    A_PUPDR => 'FLOATING', A_LEVEL => 'LEVEL_HIGH',    A_ASCR => 'ASCR_DISABLED', A_LOCKR => 'LOCKR_DISABLED', A_AF => '0', A_ADCCHAN => 0},
		     ...
		     'I2C' 	=> {A_MODE => 'ALTERNATE', A_OTYPE => 'OPENDRAIN', A_SPEED => 'SPEED_HIGH',    A_PUPDR => 'FLOATING', A_LEVEL => 'LEVEL_HIGH',    A_ASCR => 'ASCR_DISABLED', A_LOCKR => 'LOCKR_DISABLED', A_ADCCHAN => 0},
		     ...
		     'ULPI' 	=> {A_MODE => 'ALTERNATE', A_OTYPE => 'PUSHPULL',  A_SPEED => 'SPEED_MEDIUM',  A_PUPDR => 'FLOATING', A_LEVEL => 'LEVEL_LOW',     A_ASCR => 'ASCR_DISABLED', A_LOCKR => 'LOCKR_DISABLED', A_ADCCHAN => 0},
		     ...
		     'LTDC'     => {A_MODE => 'ALTERNATE', A_OTYPE => 'PUSHPULL',  A_SPEED => 'SPEED_HIGH',    A_PUPDR => 'FLOATING', A_LEVEL => 'LEVEL_HIGH',    A_ASCR => 'ASCR_DISABLED', A_LOCKR => 'LOCKR_DISABLED', A_ADCCHAN => 0},
