...
#define FPORT_TX_READBACK_DOCHECK false
 ...
 /**
   ...
   * @param[in]  fportp     pointer to a @p FPORTDriver structure
   */
  static inline FportErrorMask fportSdGetAnClearErrors(FPORTDriver *fportp)
  {
   ...
   static inline int16_t fportSdGetChannel(const FPORTDriver *fportp, const size_t channelIdx) {
