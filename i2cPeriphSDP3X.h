...
typedef enum __attribute__ ((__packed__)) {
  SDP3X_NOT_INITIALIZED = 0x0,
    SDP3X_CONTINUOUS_MASSFLOW_AVERAGE = BSWAP16(0x3603), 
    SDP3X_CONTINUOUS_MASSFLOW_IMMEDIATE = BSWAP16(0x3608),
    SDP3X_CONTINUOUS_DIFFPRESS_AVERAGE = BSWAP16(0x3615),
    SDP3X_CONTINUOUS_DIFFPRESS_IMMEDIATE = BSWAP16(0x361E),
    SDP3X_STOP_CONTINUOUS = BSWAP16(0x3FF9),
    SDP3X_ONESHOT_MASSFLOW = BSWAP16(0x3726),
    SDP3X_ONESHOT_DIFFPRESS = BSWAP16(0x372D),
    SDP3X_SLEEP = BSWAP16(0x3677),
