...
#else
#define	GPIOC_SDIO_D0  SDMMC1_D0
#define	GPIOC_SDIO_D1  SDMMC1_D1
#define	GPIOC_SDIO_D2  SDMMC1_D2
#define	GPIOC_SDIO_D3  SDMMC1_D3
#define GPIOC_SDIO_CK  SDMMC1_CK
#define GPIOD_SDIO_CMD SDMMC1_CMD
#endif
#endif
#endif
